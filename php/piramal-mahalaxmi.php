...
// subject 
$subject = 'Mumbai Projects Home - Piramal Mahalaxmi Mumbai';   
// message
$message = '
<table>    
  <tr>
  ...
  <tr>
    <td>Mobile</td><td>('.$_REQUEST['countryCode'].')'.$_REQUEST['mobile'].'</td>
  </tr>
  <tr>
...
// Additional headers  
$headers .= 'From: Mumbai Projects Home - Piramal Mahalaxmi Mumbai<enquiry@propzilla.in>' . "\r\n";
